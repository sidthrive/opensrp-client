...
public class ClientsList extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceBundle){
        ...
        final org.ei.opensrp.indonesia.face.camera.ImageConfirmation im = new ImageConfirmation();
        ...
        gv_clientList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                ...
                if (deleteUser && !updateUser) {
                    new AlertDialog.Builder(org.ei.opensrp.indonesia.face.camera.ClientsList.this)
                            .setMessage(
