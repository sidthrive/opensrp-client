...
public class ClientAdapter extends BaseAdapter {
    private static final String TAG = org.ei.opensrp.indonesia.face.camera.util.ClientAdapter.class.getCanonicalName();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            gridview = inflater.inflate(R.layout.base_id_clients, null);
        } else{
