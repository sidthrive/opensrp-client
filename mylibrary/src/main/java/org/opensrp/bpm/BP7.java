...
//        });
    ...
    public void onClick(View arg0) {
        int i = arg0.getId();
        if (i == R.id.btn_getbattery) {
            if (bp7Control != null) {
                bp7Control.getBattery();
            } else
                Toast.makeText(BP7.this, "bp7Control == null", Toast.LENGTH_LONG).show();

        } else if (i == R.id.btn_isOfflineMeasure) {
            if (bp7Control != null)
                bp7Control.isEnableOffline();
            else
                Toast.makeText(BP7.this, "bp7Control == null", Toast.LENGTH_LONG).show();

        } else if (i == R.id.btn_enableOfflineMeasure) {
            if (bp7Control != null)
                bp7Control.enbleOffline();
            else
                Toast.makeText(BP7.this, "bp7Control == null", Toast.LENGTH_LONG).show();

        } else if (i == R.id.btn_disableOfflineMeasure) {
            if (bp7Control != null)
                bp7Control.disableOffline();
            else
                Toast.makeText(BP7.this, "bp7Control == null", Toast.LENGTH_LONG).show();

        } else if (i == R.id.btn_startMeasure) {
            if (bp7Control != null) {
                bp7Control.startMeasure();
            } else
                Toast.makeText(BP7.this, "bp7Control == null", Toast.LENGTH_LONG).show();

        } else if (i == R.id.btn_conform_angle) {
            if (bp7Control != null)
                bp7Control.conformAngle();
            else
                Toast.makeText(BP7.this, "bp7Control == null", Toast.LENGTH_LONG).show();

        } else if (i == R.id.btn_stopMeasure) {
            if (bp7Control != null)
                bp7Control.interruptMeasure();
            else
                Toast.makeText(BP7.this, "bp7Control == null", Toast.LENGTH_LONG).show();

        } else if (i == R.id.btn_getOfflineNum) {
            if (bp7Control != null)
                bp7Control.getOfflineNum();
            else
                Toast.makeText(BP7.this, "bp7Control == null", Toast.LENGTH_LONG).show();

        } else if (i == R.id.btn_getOfflineData) {
            if (bp7Control != null)
