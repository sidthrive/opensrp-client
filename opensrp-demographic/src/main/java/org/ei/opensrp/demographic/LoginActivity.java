...
public class LoginActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getActionBar().setIcon(getResources().getDrawable(org.ei.opensrp.demographic.R.mipmap.logo));
        getActionBar().setBackgroundDrawable(getResources().getDrawable(org.ei.opensrp.demographic.R.color.action_bar_background));
        setLanguage();
