...
public class NativeHomeActivity extends SecuredActivity {
    ...
    protected void onCreation() {
        //home dashboard
        setContentView(R.layout.smart_registers_demographic_home);
        navigationController = new DemogNavigationController(this,anmController);
        setupViews();
        initialize();
    ...
    private void setupViews() {
        findViewById(R.id.btn_demographic_register).setOnClickListener(onRegisterStartListener);
       // findViewById(R.id.btn_test2_register).setOnClickListener(onRegisterStartListener);

//        findViewById(R.id.btn_reporting).setOnClickListener(onButtonsClickListener);
//        findViewById(R.id.btn_videos).setOnClickListener(onButtonsClickListener);

        ecRegisterClientCountView = (TextView) findViewById(R.id.txt_demographic_register_client_count);
    ...
    private void initialize() {
        ...
        getSupportActionBar().setIcon(getResources().getDrawable(org.ei.opensrp.demographic.R.mipmap.logo));
        getSupportActionBar().setLogo(org.ei.opensrp.demographic.R.mipmap.logo);
...
// urces().getDrawable(R.color.action_bar_background));
    ...
    private void updateRegisterCounts(HomeContext homeContext) {
        CommonPersonObjectController childcontroller = new CommonPersonObjectController(context.allCommonsRepositoryobjects("kartu_keluarga"),
                context.allBeneficiaries(), context.listCache(),
                context.personObjectClientsCache(),"nama_kk","kartu_keluarga","tgl_kk", CommonPersonObjectController.ByColumnAndByDetails.byDetails);
    ...
    private View.OnClickListener onRegisterStartListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            switch (view.getId()) {
            //    case R.id.btn_demographic_register:
