 ...
 */
public class DemogLocationSelectorDialogFragment extends DialogFragment {
    ...
    private DemogLocationSelectorDialogFragment(SecuredNativeSmartRegisterActivity activity,
    ...
    public static DemogLocationSelectorDialogFragment newInstance(
            SecuredNativeSmartRegisterActivity activity,
            DialogOptionModel dialogOptionModel,
            String locationJSONString,String formname) {
        return new DemogLocationSelectorDialogFragment(activity, dialogOptionModel, locationJSONString,formname);
    }
