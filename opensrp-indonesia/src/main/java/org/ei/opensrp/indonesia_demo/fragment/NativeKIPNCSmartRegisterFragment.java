...
import org.ei.opensrp.indonesia_demo.pnc.KIPNCClientsProvider;
import org.ei.opensrp.indonesia_demo.pnc.KIPNCOverviewServiceMode;
...
//                searchCancelView.setVisibility(isEmpty(cs) ? INVISIBLE : VISIBLE);
    ...
    public void getFacialRecord(View view) {
        ...
        intent.putExtra("org.sid.sidface.ImageConfirmation.origin", NativeKIPNCSmartRegisterFragment.class.getSimpleName());
