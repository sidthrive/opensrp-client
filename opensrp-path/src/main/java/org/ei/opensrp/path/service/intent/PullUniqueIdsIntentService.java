...
public class PullUniqueIdsIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            ...
            String localUrlString = PathConstants.OPENMRS_URL + PathConstants.OPENMRS_IDGEN_URL + "?source=1&numberToGenerate=" + numberToGenerate + "&username=" + userName + "&password=" + password;
