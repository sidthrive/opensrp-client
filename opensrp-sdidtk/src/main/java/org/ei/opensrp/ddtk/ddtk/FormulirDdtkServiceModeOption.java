...
public class FormulirDdtkServiceModeOption extends ServiceModeOption {

    public FormulirDdtkServiceModeOption(SmartRegisterClientsProvider provider) {
        super(provider);
    }

    @Override
    public String name() {
       return Context.getInstance().getStringResource(R.string.instrumen_sdidtk);
    }
