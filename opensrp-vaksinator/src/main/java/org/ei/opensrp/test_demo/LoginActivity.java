...
public class LoginActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getActionBar().setIcon(getResources().getDrawable(org.ei.opensrp.test_demo.R.mipmap.logo));
        getActionBar().setBackgroundDrawable(getResources().getDrawable(org.ei.opensrp.test_demo.R.color.action_bar_background));
        setLanguage();
