...
public class NativeHomeActivity extends SecuredActivity {
    ...
    protected void onCreation() {
      ...
      //  FlurryFacade.logEvent("vaksinator_home_dashboard");
        navigationController = new org.ei.opensrp.test_demo.TestNavigationController(this,anmController);
        setupViews();
        initialize();
...
//        findViewById(R.id.btn_tt_register).setOnClickListener(onRegisterStartListener);
    ...
    private void initialize() {
        ...
        getSupportActionBar().setIcon(getResources().getDrawable(org.ei.opensrp.test_demo.R.mipmap.logo));
        getSupportActionBar().setLogo(org.ei.opensrp.test_demo.R.mipmap.logo);
...
// urces().getDrawable(R.color.action_bar_background));
    ...
    private void updateRegisterCounts(HomeContext homeContext) {
        ...
        Cursor childcountcursor = context.commonrepository("anak").RawCustomQueryForAdapter(sqb.queryForCountOnRegisters("anak", "anak.nama_bayi NOT Null and anak.nama_bayi !='' AND ((isClosed IS NULL) OR isClosed = 'false')"));
