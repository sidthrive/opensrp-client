 ...
 */
public class TestLocationSelectorDialogFragment extends DialogFragment {
    ...
    public static TestLocationSelectorDialogFragment newInstance(
            SecuredNativeSmartRegisterActivity activity,
            DialogOptionModel dialogOptionModel,
            String locationJSONString,String formname) {
        return new TestLocationSelectorDialogFragment(activity, dialogOptionModel, locationJSONString,formname);
    }
