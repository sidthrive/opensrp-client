...
//        String baseURL = configuration.dristhiBaseURL();
        while (true) {
            String uri = allSharedPreferences.fetchHost("")+":"+allSharedPreferences.fetchPort(8080)+"/openmrs/module/idgen/exportIdentifiers.form?source=1&numberToGenerate="+Integer.toString(100)+"&username="+username+"&password="+password;
            logDebug(format("Unique id uri : {0}",uri));
